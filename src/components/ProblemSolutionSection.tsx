        ...
        <section>
            ...
            <div className="relative mt-16 overflow-hidden">
                ...
                <img
                    src="/problem-bg.png"
                    alt=""
                    className="absolute left-0 top-4 h-96 w-[52%] object-cover opacity-80"
                />
                <img
                    src="/solution-bg.png"
                    alt=""
                    className="absolute right-0 top-8 h-96 w-[60%] object-cover opacity-80"
                />
                <img
                    src="/blob-tear.png"
                    alt=""
                ...
                <div className="relative z-40 container mx-auto px-6 md:px-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
                        ...
                        <div className='mt-8 mr-20'>
                            <p className="text-3xl font-semibold mb-4">The Problem:</p>
                            <p className="mb-4">
                        ...
                        {/* Solution section */}
                        <div className='mt-10'>
                            <p className="text-3xl font-semibold mt-4 mb-4">The Tmoraa Solution:</p>
                    ...
                    <div className="mt-40 mb-32 text-center">
                        <h2 className="text-4xl font-semibold">Seamlessly Connect Your Entire</h2>
                        <h2 className="text-4xl font-semibold mt-1">Tech Stack</h2>
                        <p className="mt-5 w-full md:w-4/5 mx-auto">
