...
export default function HowItWorksSection() {
    return (
        <section className='relative h-fit overflow-hidden'>
            ...
            <img src="/mission-card-top.png" alt='' className='hidden md:block absolute left-40 top-[56%] object-cover -z-40' />
            <img src="/mission-card-bottom.png" alt='' className='hidden md:block absolute right-40 bottom-[2%] object-cover -z-40' />

            <div className='pt-12 md:pt-20 mb-12 md:mb-16 flex justify-center items-center'>
                <h2 className='text-3xl md:text-5xl text-black font-semibold'>Workflow</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 px-6 lg:px-0 mt-16 lg:mt-0 pb-16 lg:pb-0">
                <div className={'lg:ml-60 lg:mr-2 lg:mt-32 lg:mb-32 p-8 rounded-3xl bg-[#EAF8F3] z-30'}>
                ...
                <div className={'lg:ml-2 lg:mr-60 lg:mt-44 lg:mb-24 p-8 rounded-3xl bg-[#D8EFFF] z-30'}>
