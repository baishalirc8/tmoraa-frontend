    ...
    return (
        <section id='contactUs' className='relative'>
            ...
            <div className="py-16 flex justify-center">
                <div
                    className="w-full max-w-4xl rounded-2xl bg-[url('/contact-card.png')] bg-cover bg-center bg-no-repeat shadow-lg p-10 px-16 text-white"
                >
                    <div className="text-center mb-20">
                        <h2 className="text-4xl font-semibold">
                            We’re Here To Help You Run Smarter
                        </h2>
                        <p className="text-sm mt-4 px-20">
                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-12">
                        ...
                        <div className='flex justify-end sm:col-span-2'>
                            <button
                                type="submit"
                                className='hover:underline text-[20px] cursor-pointer'
                            >
